                            ...
                            <div class="modal-body" style="padding: 4%">
                                <div class="row">
                                    <h3 style="margin-bottom: 5%;" class="d-flex justify-content-start">تعديل
                                        إعدادات الشركات المنفذه </h3>


                                    <div class="row">
                                        <h1 class="gradient-text">الشركات المنفذة</h1>
                                    </div>

                                    <div>

                                        <form class="voucher-form" action="/edit-involved-companies-settings" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div id="certificate-row2" class="row mt-4 mb-4">


                                                <div class="col-lg-4  col-xs-12 mb-3 d-flex justify-content-center" style="padding:0px">
                                                    <div class="input-content">
                                                        <div class="">
                                                            <input type="file" name="logo" id="involved" class="inputfile inputfile-6">
                                                            <label for="involved"><span class="file-text"></span>
                                                ...
                                                <div class="col-lg-4 col-xs-12" style="margin-inline-start: 8px;margin-bottom: 20px;">
                                                    <input type="text" name="title" class="form-control" placeholder="عنوان الشعار" style="height: 45px; border-radius: 5px;border: 1px solid #d3394c; background-color: #f1e5e6;">
                                                </div>


                                                <div class="col-lg-3 col-xs-12 mb-3 d-flex justify-content-start" style="margin-inline-start: 8px;">
                                                    <button type="submit" class="btn btn-light" style="height: 45px;"><i style="color:red; font-weight: 800;" class="bi bi-plus-lg"></i>اضف</button>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-xs-6 d-flex align-items-center" style="margin-bottom: 10px;">
                                            ...
                                            <div class="col-lg-6 justify-content-start">
                                                <span class="title-image">{{$item->title}}</span>

                                            </div>

                                            <div class="col-lg-2 col-xs-6">
                                                <a href="/delete-involved-companies-logo/{{$item->id}}" onclick="return confirm('هل أنت متأكد من رغبتك في حذف هذا الشعار؟')" class="btn btn-small btn-danger btn-visitor-delete">
                                                    X
                                                </a>
                                            </div>
