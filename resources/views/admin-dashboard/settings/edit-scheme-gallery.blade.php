                    ...
                    <div class="container" style="overflow-x: scroll;">
                        ...
                        <div class="modal-content">
                            <div class="modal-body" style="padding: 4%">
                                <div class="row">
                                    <h3 style="margin-bottom: 5%;" class="d-flex justify-content-start">إضافة صورة إلى معرض الصور</h3>

                                    <form class="voucher-form" action="/save-scheme-gallery" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div id="certificate-row2" class="row mt-4 mb-4">
                                            ...
                                            <div class="col-lg-6  col-xs-12 mb-3 d-flex justify-content-center" style="padding:0px">
                                                <div class="input-content">
                                                    <div class="">
                                                        <input type="file" name="house-img" id="success" class="inputfile inputfile-6">
                                            ...
                                            <div class="col-lg-6 col-xs-12 mb-3 d-flex justify-content-start">
                                                <button type="submit" class="btn btn-light"><i style="color:#470065; font-weight: 800;" class="bi bi-plus-lg"></i>اضف</button>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xs-6 d-flex align-items-center" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-lg-6 col-xs-6">
                                            <div class="img-box">
                                                <img class="image-update" src="{{$item->path}}">

                                            </div>
                                        </div>

                                        <div class="col-lg-6 col-xs-6">
                                            <a href="/delete-scheme-gallery/{{$item->id}}" onclick="return confirm('هل أنت متأكد من رغبتك في حذف هذا الشعار؟')" class="btn btn-small btn-danger btn-visitor-delete">
                                                X
                                            </a>
                                        </div>
