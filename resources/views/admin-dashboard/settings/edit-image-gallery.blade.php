                        ...
                        <div class="modal-content">
                            <div class="modal-body" style="padding: 4%">
                                <div class="row">
                                    ...
                                    <form class="voucher-form" action="/save-image-gallery" method="post" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xs-6 d-flex align-items-center" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-lg-6 col-xs-6">
                                            <a href="/delete-image-gallery/{{$item->id}}" onclick="return confirm('هل أنت متأكد من رغبتك في حذف هذا الشعار؟')" class="btn btn-small btn-danger btn-visitor-delete">
                                                X
                                            </a>
                                        </div>
