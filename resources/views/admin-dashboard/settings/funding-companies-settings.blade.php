...
@media (max-width: 768px) {
    ...
    #certificate-row, #certificate-row2{
            ...
            <div id="users" class="tabcontent">
                ...
                <section class="main-content">
                    ...
                    <div class="container" style="overflow-x: scroll;">
                        ...
                        <form class="voucher-form" action="/edit-funding-companies-settings" method="post" enctype="multipart/form-data">
                            @csrf

                            <div class="modal-content">
                                <div class="modal-body" style="padding: 4%">
                                    <div class="row">
                                        <h3 style="margin-bottom: 5%;" class="d-flex justify-content-start">تعديل إعدادات الجهات التمويلية</h3>
                                        ...
                                        <div>
                                            ...
                                            <div id="certificate-row2" class="row">


                                                <div class="col-lg-6  col-xs-12 mb-3 d-flex justify-content-center" style="padding:0px">
                                                    <div class="input-content">
                                                        <div class="">
                                                            <input type="file" name="logo" id="file-cert-new-0" class="inputfile inputfile-6">
                                                            <label for="file-cert-new-0"><span class="file-text"></span>
                                                ...
                                                <div class="col-lg-6 col-xs-12 mb-3 d-flex justify-content-start">
                                                    <button type="submit" class="btn btn-light"><i style="color:red; font-weight: 800;"
                                                        class="bi bi-plus-lg"></i>اضف</button>
                                                </div>
                                        ...
                                        <div id="certificate-row" class="">
                                            <div class="col-lg-4 col-xs-6 justify-content-center">
                                                <div class="img-box">
                                            ...
                                            <div class="col-lg-4 col-xs-6">
                                                <a href="/delete-logo/{{$item->id}}" onclick="return confirm('هل أنت متأكد من رغبتك في حذف هذا الشعار؟')" class="btn btn-small btn-danger btn-visitor-delete">
                                                      X
                                                    </a>
                                            </div>
